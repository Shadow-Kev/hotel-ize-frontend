...
namespace hotel_ize_frontend.Client.Infrastructure.ApiClient
{
    ...
    public partial interface IClientsClient : IApiService
    {
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PaginationResponseOfClientDetailsDto> SearchAsync(SearchClientsRequest request);
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PaginationResponseOfClientDetailsDto> SearchAsync(SearchClientsRequest request, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class ClientsClient : IClientsClient
    {
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<PaginationResponseOfClientDetailsDto> SearchAsync(SearchClientsRequest request)
        {
            return SearchAsync(request, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<PaginationResponseOfClientDetailsDto> SearchAsync(SearchClientsRequest request, System.Threading.CancellationToken cancellationToken)
        {
            if (request == null)
                throw new System.ArgumentNullException("request");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<PaginationResponseOfClientDetailsDto>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.0.3.0 (NJsonSchema v11.0.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class PaginationResponseOfClientDetailsDto
    {
        [Newtonsoft.Json.JsonProperty("data", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<ClientDetailsDto> Data { get; set; } = default!;
